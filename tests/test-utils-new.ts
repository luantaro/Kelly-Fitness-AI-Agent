...
export class PageSelectors {
  ...
  static readonly PROFILE_NAME_INPUT =
    'input[placeholder*="tên"], input[placeholder*="Nhập tên"]';
  static readonly PROFILE_AGE_INPUT =
    'input[placeholder*="tuổi"], input[placeholder*="Nhập tuổi"]';
  static readonly PROFILE_HEIGHT_INPUT =
    'input[placeholder*="chiều cao"], input[placeholder*="height"]';
  static readonly PROFILE_WEIGHT_INPUT =
    'input[placeholder*="cân nặng"], input[placeholder*="weight"]';
